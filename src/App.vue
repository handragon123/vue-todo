...
// reactive함수 : 객체 데이터에 반응성을 주입하여 값이 변경되면 린레더링이 되어 화면이 갱신됨
const data = reactive({
  newItem: '',
  items: [],
});
...
<template>
  <main class="app">
    ...
    <ul class="todo_list">
      ...
      <!-- 리스트는 고유 id가 필요하여 key속성을 연결하여야함 -->
      <!-- todo.completed 가 true면 completed문자열이 클래스명이 됨 -->
      <li
      ...
      >
        ...
        />
        <!-- 라벨클릭시 for로 연결된 체크박스에서 true,false발생 -->
